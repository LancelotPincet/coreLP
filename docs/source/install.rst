...
To finish, some routines may be provided with the library **coreLP** :doc:`(see Reference Guide) <routines>`.
To use them, you can just download `routines source codes <https://github.com/LancelotPincet/coreLP/tree/main/src/corelp/routines>`_.
...
Now, you can clone in your current directory the `source code folder <https://github.com/LancelotPincet/coreLP>`_ with the following command
