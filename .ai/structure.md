...
- The library is organized under `src/corelp` into two main parts:
...
- The main object is defined in:
  - `myname.py`
  - and imported as: `from corelp import myname`
...
- All such objects become importable from the package root directly with ```from corelp import myname```.
