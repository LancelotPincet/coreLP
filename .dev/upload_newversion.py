...
"""
Upload new realease for coreLP
"""
...
def main() :
    ...
    # Warning
    print('     coreLP newest version is about to be put online.')
    stop_upload = True
    upload = input("     Are you sure you want to upload coreLP new version? y/[n] >>> ")
